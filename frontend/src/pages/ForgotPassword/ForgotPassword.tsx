...
import { forgotPasswordSchema } from "@/lib/validators/forgot.schema";
...
export default function ForgotPassword() {
  ...
  return (
    <AuthLayout
      ...
      description="Enter your registered email and we’ll help you get back into your community in no time."
    >
